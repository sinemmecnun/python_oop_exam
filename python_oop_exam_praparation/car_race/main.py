...
print(controller.create_car("MuscleCar", "test", 430))
print(controller.create_car("MuscleCar", "testtt", 430))

print(controller.cars)
print(controller.create_driver("Peter"))
print(controller.create_driver("Pete"))
print(controller.drivers)
print(controller.create_race("test"))
print(controller.add_car_to_driver("Pete", "MuscleCar"))
print(controller.add_car_to_driver("Pete", "MuscleCar"))
